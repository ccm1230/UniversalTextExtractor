...
export const ClipboardCopyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.75m0 0A2.25 2.25 0 0113.5 12h-3a2.25 2.25 0 01-2.25-2.25V6.75m11.25-3H8.25a2.25 2.25 0 00-2.25 2.25v7.5M21 12a2.25 2.25 0 01-2.25 2.25H5.25a2.25 2.25 0 01-2.25-2.25V5.25A2.25 2.25 0 015.25 3h7.5a2.25 2.25 0 012.25 2.25v7.5z" />
  </svg>
);
